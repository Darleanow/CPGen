 ...
 *       The application checks font support at startup via @ref System::isFontValid.
 *
 * @author Darleanow
 */
...
/// @{
inline constexpr const char *RADIO_UNCHECKED   = "\U000F0130"; ///< Empty radio button.
inline constexpr const char *RADIO_CHECKED     = "\U000F0134"; ///< Filled radio button.
inline constexpr const char *CHECKBOX_UNCHECKED = "\U000F0131"; ///< Empty checkbox.
inline constexpr const char *CHECKBOX_CHECKED   = "\U000F0856"; ///< Checked checkbox.
/// @}

/// @name Navigation
/// @{
inline constexpr const char *CURSOR = "\uf061"; ///< Arrow cursor indicating the focused item.
/// @}
...
inline constexpr const char *CMAKE_ICON  = "\ue794";     ///< CMake build system icon.
inline constexpr const char *GIT_ICON    = "\ue702";     ///< Git version control icon.
inline constexpr const char *GOOGLE_ICON = "\ue7f0";     ///< Google / GoogleTest icon.
/// @}

/// @name Generic icons (Nerd Font)
/// @{
inline constexpr const char *PACKAGES_ICON = "\U000F03D6"; ///< Package/dependency icon.
inline constexpr const char *ROCKET_ICON   = "\U000F14DF"; ///< Rocket / launch icon.
inline constexpr const char *GEAR_ICON     = "\uf013";     ///< Settings / configuration icon.
/// @}
...
/// @{
inline constexpr const char *PROGRESS_EMPTY_LEFT  = "\uee00"; ///< Empty progress bar — left cap.
inline constexpr const char *PROGRESS_EMPTY_MID   = "\uee01"; ///< Empty progress bar — middle fill.
inline constexpr const char *PROGRESS_EMPTY_RIGHT = "\uee02"; ///< Empty progress bar — right cap.
inline constexpr const char *PROGRESS_FULL_LEFT   = "\uee03"; ///< Full progress bar — left cap.
inline constexpr const char *PROGRESS_FULL_MID    = "\uee04"; ///< Full progress bar — middle fill.
inline constexpr const char *PROGRESS_FULL_RIGHT  = "\uee05"; ///< Full progress bar — right cap.
/// @}
...
inline constexpr const char *ERROR_ICON = "\uea87"; ///< Error / failure indicator.
